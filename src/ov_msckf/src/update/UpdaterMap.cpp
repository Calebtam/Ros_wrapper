...
UpdaterMap::UpdaterMap(UpdaterOptions &options_slam, UpdaterOptions &options_aruco, ov_core::FeatureInitializerOptions &feat_init_options)
...
void UpdaterMap::update(std::shared_ptr<State> state, std::vector<std::shared_ptr<Feature>> &feature_vec) {
...
void UpdaterMap::change_anchors(std::shared_ptr<State> state) {
...
void UpdaterMap::perform_anchor_change(std::shared_ptr<State> state, std::shared_ptr<Landmark> landmark, double new_anchor_timestamp,
                                       size_t new_cam_id) {
