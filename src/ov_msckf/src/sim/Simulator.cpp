...
Simulator::Simulator(std::shared_ptr<VioManagerOptions> &params_) {
...
void Simulator::perturb_parameters(std::mt19937 gen_state, std::shared_ptr<VioManagerOptions> &params_) {
