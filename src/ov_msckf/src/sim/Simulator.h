...
public:
   ...
   */
  Simulator(std::shared_ptr<VioManagerOptions> &params_);
   ...
   */
  static void perturb_parameters(std::mt19937 gen_state, std::shared_ptr<VioManagerOptions> &params_);
  ...
  std::shared_ptr<VioManagerOptions> get_true_parameters() { return params; }
