...
target_link_libraries(ov_msckf_lib ${thirdparty_libraries} )  ## rbs
...
#     add_executable(rosbag_msckf_mono src/run_msckf_mono.cpp)
#     target_link_libraries(rosbag_msckf_mono ov_msckf_lib ${thirdparty_libraries})
#     install(TARGETS rosbag_msckf_mono
#             ARCHIVE DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
#             LIBRARY DESTINATION ${CATKIN_PACKAGE_LIB_DESTINATION}
#             RUNTIME DESTINATION ${CATKIN_PACKAGE_BIN_DESTINATION}
#             )
