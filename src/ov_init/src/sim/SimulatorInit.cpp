...
SimulatorInit::SimulatorInit(std::shared_ptr<InertialInitializerOptions> &params_) {
...
void SimulatorInit::perturb_parameters(std::shared_ptr<InertialInitializerOptions> &params_) {
