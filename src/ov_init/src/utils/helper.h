...
//    data.wm = (1 - lambda) * imu_1.wm + lambda * imu_2.wm;
    ...
    imu->linear_acceleration.x = (1 - lambda) * imu_1.data->linear_acceleration.x + lambda * imu_2.data->linear_acceleration.x;
    imu->linear_acceleration.y = (1 - lambda) * imu_1.data->linear_acceleration.y + lambda * imu_2.data->linear_acceleration.y;
    imu->linear_acceleration.z = (1 - lambda) * imu_1.data->linear_acceleration.z + lambda * imu_2.data->linear_acceleration.z;
    imu->angular_velocity.x = (1 - lambda) * imu_1.data->angular_velocity.x + lambda * imu_2.data->angular_velocity.x;
    imu->angular_velocity.y = (1 - lambda) * imu_1.data->angular_velocity.y + lambda * imu_2.data->angular_velocity.y;
    imu->angular_velocity.z = (1 - lambda) * imu_1.data->angular_velocity.z + lambda * imu_2.data->angular_velocity.z;
    data.data = imu;
    return data;
  }
