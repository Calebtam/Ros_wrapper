...
public:
  ...
  /**
   * @brief return keyframes' timestamp sorted by tracked features. Keyframes whose
   * tracked feature are below than threshold will return.
   */
  std::vector<double> get_marg_keyframes();
